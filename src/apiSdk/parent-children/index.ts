...
import { ParentChildInterface, ParentChildGetQueryInterface } from 'interfaces/parent-child';
import { GetQueryInterface } from '../../interfaces';

export const getParentChildren = async (query?: ParentChildGetQueryInterface) => {
